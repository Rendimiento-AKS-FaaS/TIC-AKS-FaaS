  ...
  while true do
    ...
    elseif fid == 2 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size36 do
          local _elem40 = iprot:readI64()
          table.insert(self.review_ids, _elem40)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function ReadReviews_args:write(oprot)
  ...
  if self.review_ids ~= nil then
    ...
    for _,iter47 in ipairs(self.review_ids) do
  ...
  while true do
    ...
    elseif fid == 0 then
      if ftype == TType.LIST then
        ...
        for _i=1,_size50 do
          local _elem54 = Review:new{}
          _elem54:read(iprot)
          table.insert(self.success, _elem54)
        end
        iprot:readListEnd()
      else
        iprot:skip(ftype)
...
function ReadReviews_result:write(oprot)
  ...
  if self.success ~= nil then
    ...
    for _,iter55 in ipairs(self.success) do
      iter55:write(oprot)
    end
    oprot:writeListEnd()
    oprot:writeFieldEnd()
