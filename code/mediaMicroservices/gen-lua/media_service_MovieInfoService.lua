  ...
  while true do
    ...
    elseif fid == 3 then
      if ftype == TType.MAP then
        self.carrier = {}
        local _ktype99, _vtype100, _size98 = iprot:readMapBegin() 
        for _i=1,_size98 do
          local _key102 = iprot:readString()
          local _val103 = iprot:readString()
          self.carrier[_key102] = _val103
        end
        iprot:readMapEnd()
      else
        iprot:skip(ftype)
...
function ReadMovieInfo_args:write(oprot)
  ...
  if self.carrier ~= nil then
    ...
    for kiter104,viter105 in pairs(self.carrier) do
